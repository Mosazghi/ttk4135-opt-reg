...
#ifndef RTW_HEADER_helicopter_new_h_
#define RTW_HEADER_helicopter_new_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_new_COMMON_INCLUDES_
#define helicopter_new_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopter_new_COMMON_INCLUDES_ */

#include "helicopter_new_types.h"
...
#define helicopter_new_rtModel         RT_MODEL_helicopter_new_T

/* Block signals (default storage) */
typedef struct {
  real_T TravelCounttorad;             /* '<S4>/Travel: Count to rad' */
  real_T Gain;                         /* '<S12>/Gain' */
  real_T Elevation;                    /* '<Root>/Sum3' */
  ...
  real_T Elevation_g;                  /* '<Root>/Sum' */
  real_T Gain_dg;                      /* '<S8>/Gain' */
  real_T TmpSignalConversionAtToFileInpo[6];
...
#define rtB                            helicopter_new_B
#define BlockIO                        B_helicopter_new_T
#define rtX                            helicopter_new_X
#define ContinuousStates               X_helicopter_new_T
#define rtXdot                         helicopter_new_XDot
#define StateDerivatives               XDot_helicopter_new_T
#define tXdis                          helicopter_new_XDis
#define StateDisabled                  XDis_helicopter_new_T
#define rtP                            helicopter_new_P
#define Parameters                     P_helicopter_new_T
#define rtDWork                        helicopter_new_DW
#define D_Work                         DW_helicopter_new_T

/* Parameters (default storage) */
struct P_helicopter_new_T_ {
...
struct tag_RTM_helicopter_new_T {
  const char_T *path;
...
extern P_helicopter_new_T helicopter_new_P;

/* Block signals (default storage) */
extern B_helicopter_new_T helicopter_new_B;

/* Continuous states (default storage) */
extern X_helicopter_new_T helicopter_new_X;

/* Block states (default storage) */
extern DW_helicopter_new_T helicopter_new_DW;

/* Model entry point functions */
extern void helicopter_new_initialize(void);
extern void helicopter_new_output(void);
extern void helicopter_new_update(void);
extern void helicopter_new_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_new_rtModel *helicopter_new(void);
...
extern RT_MODEL_helicopter_new_T *const helicopter_new_M;
 ...
 *
 * '<Root>' : 'helicopter_new'
 * '<S1>'   : 'helicopter_new/Conversion'
 * '<S2>'   : 'helicopter_new/Degrees to Radians'
 * '<S3>'   : 'helicopter_new/Elevation controller'
 * '<S4>'   : 'helicopter_new/Helicopter_interface'
 * '<S5>'   : 'helicopter_new/Pitch controller'
 * '<S6>'   : 'helicopter_new/Elevation controller/If Action Subsystem'
 * '<S7>'   : 'helicopter_new/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'helicopter_new/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'helicopter_new/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'helicopter_new/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'helicopter_new/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'helicopter_new/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'helicopter_new/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_new_h_ */
